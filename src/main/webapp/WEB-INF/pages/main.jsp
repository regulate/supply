		...
		<div class="container">
			<nav class="navbar navbar-default navbar-fixed-top">
				<div class="container">
				    ...
				    <a class="navbar-brand">SUPPLY | <small>Home page</small></a>
				</div>
			</nav>
								...
								<tr>
									...
									<td class="sm-clmn">
										<a id="edit-product" 
											...
											data-product-serial="${product.getSerial()}" 
											data-product-name="${product.getName()}"
											data-product-price="${product.getPrice()}" 
											data-product-weight="${product.getWeight()}" 
											data-product-dimensions="${product.getDimensions()}" 
											data-product-mdate="${product.getManufDate()}"
											data-product-edate="${product.getExpDate()}" 
											data-toggle="modal" 
							...
							<div class="modal-body">
								<div class="container-fluid">
									<div class="form-group">
										...
										<input id="edit-product-serial" class="form-control" type="text" name="serial" placeholder="">
									</div>
									<div class="form-group">
										<span class="label label-info">Name:</span> 
										<input id="edit-product-name" class="form-control" type="text" name="name" placeholder="">
									</div>
									<div class="form-group">
										<span class="label label-info">Price($):</span> 
										<input id="edit-product-price" class="form-control" type="number" min="0" max="99999999.99" step="1" name="price">
									</div>
									<div class="form-group">
										<span class="label label-info">Weight(kg):</span> 
										<input id="edit-product-weight" class="form-control" type="number" min="0" max="999.99" step="0.5" name="weight">
									</div>
									<div class="form-group">
										<span class="label label-info">Dimensions(LxWxH, cm):</span>
										<input id="edit-product-dimensions" class="form-control" type="text" name="dimensions" placeholder="">
									</div>
									<div class="form-group">
										<span class="label label-info">Manufactured Date(yyyy-dd-mm):</span> 
										<input id="edit-product-mdate" class="form-control" type="text" maxlength="10" name="manufDate" placeholder="">
									</div>
									<div class="form-group">
										<span class="label label-info">Expiration Date(yyyy-dd-mm):</span> 
										<input id="edit-product-edate" class="form-control" type="text" maxlength="10" name="expDate" placeholder="">
									</div>
								</div>
							</div>
						...
						<form id="product-add-form" class="form-horizontal" role="form" method="POST" action="product/add" name="product">
							<div class="modal-body">
								<div class="container-fluid">
									<div class="form-group">
										<span class="label label-info">Serial:</span> 
										<input class="form-control" type="text" name="serial" placeholder="Product Serial">
									</div>
									<div class="form-group">
										<span class="label label-info">Name:</span> 
									...
									<div class="form-group">
										<span class="label label-info">Price($):</span> 
										<input class="form-control" type="number" min="0" value="1.0" max="99999999.99" step="1" name="price">
									</div>
									<div class="form-group">
										<span class="label label-info">Weight(kg):</span> 
										<input class="form-control" type="number" min="0" value="0.5" max="999.99" step="0.5" name="weight">
									</div>
									<div class="form-group">
										<span class="label label-info">Dimensions(LxWxH, cm):</span> 
										<input class="form-control" type="text" name="dimensions" placeholder="Product Dimensions (LengthxWidthxHeight)">
									</div>
									<div class="form-group">
										<span class="label label-info">Manufactured Date(yyyy-dd-mm):</span> 
										<input class="form-control" type="text" maxlength="10" name="manufDate" placeholder="Product Manufactured Date (yyyy-dd-mm)">
									</div>
									<div class="form-group">
										<span class="label label-info">Expiration Date(yyyy-dd-mm):</span> 
										<input class="form-control" type="text" maxlength="10" name="expDate" placeholder="Product Expiration Date (yyyy-dd-mm)">
									</div>
								</div>
							</div>
							<div class="modal-footer">
