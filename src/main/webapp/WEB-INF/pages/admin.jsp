		...
		<div id="users-panel" class="panel panel-default">
			...
			<div class="panel-body">
				<button type="button" class="btn btn-success" data-toggle="modal" data-target="#add-admin">
					<span class="glyphicon glyphicon-plus-sign"></span> Add New Admin&hellip;
				</button>
			</div>
						...
						<div class="modal-body">
							<div class="container-fluid">
								<div class="form-group">
									<span class="label label-info">Email:</span> <input class="form-control" type="text" name="email">
								</div>
								<div class="form-group">
									<span class="label label-info">First Name:</span> <input class="form-control" type="text" name="firstName">
								</div>
								<div class="form-group">
									<span class="label label-info">Last Name:</span> <input class="form-control" type="text" name="lastName">
								</div>
								<div class="form-group">
									<span class="label label-info">Password:</span> <input class="form-control" type="password" name="password">
								</div>
							</div>
						</div>
